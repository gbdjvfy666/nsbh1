...
import { gsap, SplitText, CustomEase, ScrambleTextPlugin } from 'gsap/all';
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function initializeAnimation() {
    ...
    const focusElement = document.getElementById('focus-bg');
    // Пример анимации с JS
    setInterval(() => {
      focusElement.style.opacity = Math.random();
    }, 1000);
  }, []);
